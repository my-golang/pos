...
namespace LL.POS.Common
{
    using System;
    using System.Data;
    //using LL.POS.Common.POSServices;
    public class PosServiceProvider
    {
        ...
        /// <param name="tablePay"></param>
        /// <param name="posPath"></param>
        /// <param name="tableSale"></param>
        /// <returns></returns>
        ...
        /// <param name="posPath">服务地址</param>
        /// <param name="opMark">调用方法标示</param>
        /// <param name="branch_no">门店信息</param>
        /// <returns></returns>
