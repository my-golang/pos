...
namespace LL.POS
{
    ...
    public partial class FrmInitData : Form
    {
        ...
        private bool ValidatePos(string branch_no, string posid)
        {
            ...
            //    if (disk == LL.Common.GobalStaticString.UN_KNOWN_DISK || string.IsNullOrEmpty(disk))
            //    {
            ...
            //                    {
            //                        LoggerHelper.Log("MsmkLogger", "LL.POS->Init->FrmInitData->ValidatePos->Exception:Key" + _kv.Key + ",Value:" + _kv.Value, LogEnum.ExceptionLog);
            //                    }
            //                    break;
            //            }
            //        }
