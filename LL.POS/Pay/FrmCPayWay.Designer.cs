namespace LL.POS
{
    partial class FrmCPayWay
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btn_Query = new LL.POS.Common.ButtonEx(this.components);
            this.btn_Add = new LL.POS.Common.ButtonEx(this.components);
            this.btn_Alter = new LL.POS.Common.ButtonEx(this.components);
            this.btn_ESC = new LL.POS.Common.ButtonEx(this.components);
