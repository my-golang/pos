...
namespace LL.POS
{
    partial class FrmPayBalance
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tbMemberBalance = new LL.POS.Common.TextBoxEx(this.components);
            this.lbMemo = new System.Windows.Forms.Label();
            this.tbPayAmt = new LL.POS.Common.TextBoxEx(this.components);
            this.lbCardNo = new System.Windows.Forms.Label();
            this.tbMemberName = new LL.POS.Common.TextBoxEx(this.components);
