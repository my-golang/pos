...
namespace LL.POS
{
    ...
    public partial class FrmDmSheetDetail : FrmBase
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //        //    if (ExtendUtility.Instance.ParseToDecimal(_detail.real_qty.Value) <= 0)
            //        //    {
            //        //        MessageBox.Show("商品数量必须大于0", Gattr.AppTitle);
            //        //        isok111 = false;
            //        //        break;
            //        //    }
            //        //}
            //        //else
            //        //{
            //        //    MessageBox.Show("商品数量不能为空", Gattr.AppTitle);
            //        //    isok111 = false;
            //        //    break;
            //        //}
            //        _detail.other1 = ExtendUtility.Instance.ParseToString(dgvr.Cells["other1"].Value);
            ...
            //{
            //    #region 分店调货
            //    //t_im_sheet_master _master2 = new t_im_sheet_master
            //    //{
            //    //    order_man = Gattr.CashierNo,
            //    //    oper_id = Gattr.CashierNo,
            //    //    d_branch_no = Gattr.BranchNo,
            //    //    branch_no = this.txtdBranchNO.Text,
            //    //    memo = this.txtRemark.Text.Contains(this.flagBody) ? this.txtRemark.Text : (this.txtRemark.Text + this.flagBody)
            //    //};
            //    //List<t_im_sheet_detail> list2 = new List<t_im_sheet_detail>();
            //    //if (string.IsNullOrEmpty(_master2.branch_no))
            //    //{
            //    //    MessageBox.Show("请输入发货门店", Gattr.AppTitle);
            //    //    return;
            //    //}
            //    //if (_master2.d_branch_no.Equals(_master2.branch_no))
            //    //{
            ...
            //    //if (this.dgvItemList.Rows.Count <= 0)
            //    //{
            //    //    MessageBox.Show("没有选择商品", Gattr.AppTitle);
            //    //    return;
            //    //}
            //    //foreach (DataGridViewRow row in (System.Collections.IEnumerable)this.dgvItemList.Rows)
            //    //{
            //    //    t_im_sheet_detail _detail2 = new t_im_sheet_detail
            //    //    {
            //    //        item_no = SIString.TryStr(row.Cells["item_no"].Value),
            //    //        real_qty = new decimal?(SIString.TryDec(row.Cells["real_qty"].Value)),
            //    //        large_qty = new decimal?(SIString.TryDec(row.Cells["real_qty"], 0M) / SIString.TryDec(row.Cells["purchase_spec"], 1M)),
            //    //        memo = SIString.TryStr(row.Cells["memo"].Value)
            //    //    };
            //    //    list2.Add(_detail2);
            //    //}
            //    //_master2.detailList = list2.ToArray();
            //    //if (string.IsNullOrEmpty(this.SheetNO))
            //    //{
            //    //    str4 = Gattr.ServerBll.InAPSheet(_master2);
            //    //    if (string.IsNullOrEmpty(str4))
            //    //    {
            //    //        MessageBox.Show("保存失败！", Gattr.AppTitle);
            //    //        return;
            //    //    }
            //    //    this.txtSheetNO.Text = str4;
            //    //}
            //    //else
            //    //{
            //    //    _master2.sheet_no = this.SheetNO;
            //    //    Gattr.ServerBll.UpAPSheet(_master2);
            //    //}
            //    #endregion
            //    MessageBox.Show("保存成功！", Gattr.AppTitle);
            ...
            //    this.btnSelectBranch.Enabled = false;
            //    this.btnSave.Enabled = !this.IsApprove;
            //    this.btnSelectItem.Enabled = !this.IsApprove;
            //    this.dgvItemList.ReadOnly = this.IsApprove;
            //    this.txtRemark.ReadOnly = this.IsApprove;
            //    this.SheetNO = this.txtSheetNO.Text;
            //    this.btnApprove.Enabled = true;
            //    this.lblApprove.Visible = this.IsApprove;
            //}
            //#endregion
        }
        /// <summary>
        ...
        private DataTable MergeData(DataTable table1, DataTable table2)
        {
            ...
            {
                LoggerHelper.Log(Gattr.LoggerName, "LL.POS->FrmDmSheetDetail-->Exception:" + ex.ToString(), LogEnum.ExceptionLog);
            }
            return table;
        }
