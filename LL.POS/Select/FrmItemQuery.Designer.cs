...
namespace LL.POS
{
    partial class FrmItemQuery
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pnlFill = new LL.POS.Common.PanelEx(this.components);
            this.dgItem = new LL.POS.Common.MyDataGridView();
            this.pnlTop = new LL.POS.Common.PanelEx(this.components);
            this.txtSearchKey = new System.Windows.Forms.TextBox();
            this.btnSerch = new LL.POS.Common.ButtonEx(this.components);
            this.label2 = new System.Windows.Forms.Label();
            this.lblTitle = new System.Windows.Forms.Label();
            this.panelEx1 = new LL.POS.Common.PanelEx(this.components);
