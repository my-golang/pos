...
namespace LL.POS
{
    partial class FrmAccount 
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tbMoney = new LL.POS.Common.TextBoxEx(this.components);
            ...
            this.btnPrint = new LL.POS.Common.ButtonEx(this.components);
            this.btnClose = new LL.POS.Common.ButtonEx(this.components);
            this.btnAccount = new LL.POS.Common.ButtonEx(this.components);
            this.btnQuery = new LL.POS.Common.ButtonEx(this.components);
