...
namespace LL.POS
{
    partial class FrmPayFlowInfoSearch
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnNext = new LL.POS.Common.ButtonEx(this.components);
            this.buttonEx4 = new LL.POS.Common.ButtonEx(this.components);
            this.btnPre = new LL.POS.Common.ButtonEx(this.components);
            this.btnOK = new LL.POS.Common.ButtonEx(this.components);
            this.txtInput = new LL.POS.Common.TextBoxEx(this.components);
