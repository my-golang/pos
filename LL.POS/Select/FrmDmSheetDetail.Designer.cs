...
namespace LL.POS
{
    partial class FrmDmSheetDetail
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnExit = new LL.POS.Common.ButtonEx(this.components);
            this.btnDelAll = new LL.POS.Common.ButtonEx(this.components);
            this.btnDel = new LL.POS.Common.ButtonEx(this.components);
            this.lblTitle = new System.Windows.Forms.Label();
            this.btnApprove = new LL.POS.Common.ButtonEx(this.components);
            this.btnSave = new LL.POS.Common.ButtonEx(this.components);
            this.label4 = new System.Windows.Forms.Label();
            this.lblApprove = new System.Windows.Forms.Label();
            this.btnSelectItem = new LL.POS.Common.ButtonEx(this.components);
            this.txtRemark = new LL.POS.Common.TextBoxEx(this.components);
            this.dateValid = new System.Windows.Forms.DateTimePicker();
            this.txtSqPersion = new LL.POS.Common.TextBoxEx(this.components);
            this.dgvItemList = new LL.POS.Common.MyDataGridView();
            this.btnSelectBranch = new LL.POS.Common.ButtonEx(this.components);
            this.txtdBranchNO = new LL.POS.Common.TextBoxEx(this.components);
            this.txtBranchNO = new LL.POS.Common.TextBoxEx(this.components);
