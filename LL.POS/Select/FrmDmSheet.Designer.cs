...
namespace LL.POS
{
    partial class FrmDmSheet
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dgvSheet = new LL.POS.Common.MyDataGridView();
            this.btnSearch = new LL.POS.Common.ButtonEx(this.components);
            this.label2 = new System.Windows.Forms.Label();
            this.cmbStatus = new System.Windows.Forms.ComboBox();
            this.btnAdd = new LL.POS.Common.ButtonEx(this.components);
            ...
            this.btnOpen = new LL.POS.Common.ButtonEx(this.components);
