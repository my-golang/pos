...
namespace LL.POS
{
    partial class FrmUpdatePwd
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tbOldPwd = new LL.POS.Common.TextBoxEx(this.components);
            ...
            this.tbSaleMan = new LL.POS.Common.TextBoxEx(this.components);
            this.tbNewPwd = new LL.POS.Common.TextBoxEx(this.components);
            this.tbReNewPwd = new LL.POS.Common.TextBoxEx(this.components);
            this.SuspendLayout();
            // 
            // lbSaleMan
            // 
