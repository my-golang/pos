...
namespace LL.POS
{
    ...
    public class PlanDealer
    {
        ...
        /// 获取PLU时满足的促销方案信息
        /// </summary>
        /// <param name="_saleInfos">所有销售流水信息</param>
        /// <returns></returns>
        ...
        /// 处理付款前商品促销信息
        /// </summary>
        /// <param name="_saleFlow">需要进行处理的销售流水</param>
        /// <returns>促销方案过滤后的促销信息</returns>
        ...
        /// 处理PLU付款时的商品流水信息
        /// </summary>
        /// <param name="plan">命中的优惠规则信息</param>
        /// <param name="saleFlows">商品流水信息</param>
        /// <returns>促销规则后的信息</returns>
        ...
        /// 处理赠送商品信息
        /// </summary>
        /// <param name="sendInfos">赠送商品信息</param>
        /// <param name="master">促销规则</param>
        /// <returns>促销过滤后的赠送信息</returns>
        ...
        /// 处理是否有商品组合的促销活动
        /// </summary>
        /// <param name="saleInfo">商品组合信息</param>
        /// <returns>商品组合的促销活动</returns>
        ...
        /// 进行折扣的处理
        /// </summary>
        /// <param name="_saleFlow">需要进行折扣处理的销售流水</param>
        /// <returns>折扣的处理后的销售流水信息</returns>
        ...
        /// 检查销售流水是否满足这个促销方案
        /// </summary>
        /// <param name="_para">促销方案信息</param>
        /// <param name="_saleInfos">促销流水</param>
        /// <returns>满足返回true否则false</returns>
        ...
        /// 根据校验类型和商品判断商品是否满足规则
        /// </summary>
        /// <param name="_checkParas">校验规则</param>
        /// <param name="_saleInfo">销售商品信息</param>
        /// <param name="_oldSales">销售所有商品信息</param>
        /// <returns>校验成功true失败false</returns>
        ...
        /// <summary>
        ///校验类型是否满足:ALL /CLS /BRAND /ITEM
        /// </summary>
        /// <param name="type_no">需要校验的类型规则ALL /CLS /BRAND /ITEM</param>
        /// <param name="type_no">需要校验的类型的值</param>
        ...
        /// 获取结果
        /// </summary>
        /// <param name="_resultParas">结果参数</param>
        /// <param name="_saleInfo">销售流水</param>
        /// <param name="item_no">商品编号</param>
        /// <param name="_oldSales">所有销售流水</param>
        /// <returns>经过处理的结果</returns>
        ...
        /// 偶数特价时的特殊处理
        /// </summary>
        /// <param name="oddSales">所有符合偶数特价的商品</param>
        /// <returns>偶数特价处理后的商品信息</returns>
        ...
        /// 处理直接特价限制数量
        /// </summary>
        /// <param name="limitSales">指定特价的销售流水</param>
        /// <param name="qty">指定的限制数量</param>
        /// <param name="plan_no">促销方案编号</param>
        /// <returns>满足限制数量的销售流水</returns>
        ...
        /// 从泛型数据中获取指定的商品的数据
        /// </summary>
        /// <param name="oldSales">所有销售流水</param>
        /// <param name="item_no">商品编号</param>
        ...
        /// <param name="plan_no">促销方案编号</param>
        /// <param name="rrule_no">排除的规则编号</param>
        /// <returns>促销方案规则</returns>
        ...
        /// <param name="rule">促销规则详细定义信息</param>
        /// <param name="i">第i条促销数据</param>
        /// <returns></returns>
